      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-[hsl(168,76%,42%)] via-[hsl(160,82%,35%)] to-[hsl(156,68%,28%)] text-primary-foreground hover:opacity-90 transition-opacity gap-2 px-8 h-12 text-base"
            >
              Get Started
