...
const r2Schema = z.object({
    ...
    credentialId: z.string().min(1, "R2 credential is required"),
...
export type R2FormValues = z.infer<typeof r2Schema>;

interface Props {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    onSubmit: (values: R2FormValues) => void;
    defaultValues?: Partial<R2FormValues>;
}


export const R2Dialog = ({
    open,
    onOpenChange,
    onSubmit,
    defaultValues = {},
    ...
    const { data: credentials, isLoading } =
        useCredentialsByType(CredentialType.R2);
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[85vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>R2 Upload</DialogTitle>
                    <DialogDescription>
                        Upload a file to R2
                    </DialogDescription>
                </DialogHeader>
                ...
                <Form {...form}>
                    ...
                    >
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>R2 Credential</FormLabel>
                                    ...
                                    <FormDescription>
                                        Add an <b>R2 credential</b> in Credentials using JSON:
