...
export const CredentialForm = ({ initialData, isDialog = false, onDialogClose }: CredentialFormProps) => {
    ...
    // For dialog mode, render without Card wrapper
    const formContent = (
        <Form {...form}>
